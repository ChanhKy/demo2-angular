...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public List<Employee> findAll() {
		...
		return employeeRepository.danhSachNhanVienFlagFalse();
	}
	...
	@Override
	public int deleteEmployeeByUpdate(int id) {
		return employeeRepository.deleteEmployeeByUpdate(id);
	}
	...
	public Page<Employee> getAllPaging(int page, int pageSize) {
		Page<Employee> list = employeeRepository.findAllByFlagFalse(PageRequest.of(page, pageSize, Sort.by("employeeId").descending()));
		return list;
	}
	...
	@Override
	public Optional<Employee> getEmployeeByFlagAndId(int id) {
		
		return employeeRepository.findByEmployeeIdAndFlagFalse(id);
	}
