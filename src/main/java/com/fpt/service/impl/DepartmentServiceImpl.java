...
public class DepartmentServiceImpl implements DepartmentService{
	...
	public Page<Department> getAllPaging(int page, int pageSize) {
		Page<Department> list = departmentRepository.findAllByFlagFalse(PageRequest.of(page, pageSize, Sort.by("departmentId").descending()));
		return list;
	}
	...
	@Override
	public int deleteDepartmentByUpdate(int id) {
		return departmentRepository.deleteDepartmentByUpdate(id);
	}

	@Override
	public Optional<Department> getDepartmentByFlagAndId(int id) {
		
		return departmentRepository.findByDepartmentIdAndFlagFalse(id);
	}
