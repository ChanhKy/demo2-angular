...
public class DepartmentRestController {
	...
	public Object getDepartments(
			...
			@RequestParam(name = "sortBy", defaultValue = "departmentName") String sortBy,
		...
		Pageable pageble = PageRequest.of(pageNumber, pageSize, Sort.Direction.fromString(sortDirection.toUpperCase()), sortBy);
	...
	public ResponseEntity<Department> getEmployeeByFlagAndId(@PathVariable int id) {
		Optional<Department> department = departmentService.getDepartmentByFlagAndId(id);
	...
	public ResponseEntity removeDepartment(@PathVariable int id) {
	...
	public ResponseEntity<Integer> deleteDepartment(@PathVariable int id) {
		...
		int count = departmentService.deleteDepartmentByUpdate(id);
		return new ResponseEntity<Integer>(count, HttpStatus.OK);
	}
