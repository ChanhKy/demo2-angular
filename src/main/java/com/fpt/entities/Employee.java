...
public class Employee {
	...
	/** The employee gender. */
	@Column(name = "employee_gender", columnDefinition = "Nvarchar(10)")
	...
	@ManyToMany()
    @JoinTable(name = "Employee_Skill", joinColumns = @JoinColumn(name = "employee_id", referencedColumnName = "employee_id"),
...
public int getEmployeeId() {
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", employeeName=" + employeeName + ", employeeGender="
				...
				+ ", employeeSalary=" + employeeSalary + ", employeeImg=" + employeeImg + ", department=" + department
				+ ", skills=" + skills + "]";
	}
