...
export class DepartmentService {
  ...
  deleteDepartmentByUpdate(department: Department):Observable<Department>  {
    return this.http.put<Department>(`${API_URL}/delete/${department.departmentId}`, department);
  }

  getDepartmentByFlagAndId(id: number): Observable<Department> {
    return this.http.get<Department>(`${API_URL}/view/${id}`);
  }
